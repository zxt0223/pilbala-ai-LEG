                                                                        #RPN (Region Proposal Network)，负责先“粗略”地找出哪里可能有物体
                                                            #原理：它在特征图上撒下无数个锚框 (Anchors)，然后快速判断这些框里“有没有东西”以及“位置偏没偏”
                #代码看点：AnchorsGenerator 类负责生成锚框。RegionProposalNetwork 类负责计算 Loss 并过滤掉大部分背景框，剩下的叫 Proposals
